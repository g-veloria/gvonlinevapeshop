...
function trusted_add_theme_help_page() {
	...
	add_theme_page(
		sprintf( esc_html__( 'Welcome to %1$s %2$s', 'trusted' ), $theme->get( 'Name' ), $theme->get( 'Version' ) ), esc_html__( 'Trusted Help', 'trusted' ), 'edit_theme_options', 'trusted', 'trusted_display_theme_help_page'
	);
}
		...
		<div id="getting-started">
			...
			<div class="columns-wrapper clearfix">
				...
				<div class="column column-half clearfix">
					...
					<div class="section">
						<h4><?php esc_html_e( 'Demo Content', 'trusted' ); ?></h4>

						<p class="about">
							<?php
							/* translators: %s: theme name. */
							printf( esc_html__( 'Import %s demo content and Starter Sites.', 'trusted' ), $theme->get( 'Name' ) ); ?>
						</p>
						<?php
						if ( class_exists( 'Starter_Sites' ) ) {
							$plugin_page = 'starter-sites';
							$plugin_text = esc_html__( 'View Demo Content', 'trusted' );
						} else {
							$plugin_page = 'tgmpa-install-plugins';
							$plugin_text = esc_html__( 'Get Starter Sites Plugin', 'trusted' );
						}
						?>
						<p>
